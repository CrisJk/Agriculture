...
public class ViolationsImport  extends DataImport {
    ...
    String seach_sql = "SELECT times from illegal where receiver_id=? AND receiver_type = ? AND year = ?";
    ...
    public void importData(ArrayList<ArrayList<String>>data){
        for(int i = 1 ;i<data.size();i++){
            ...
            ArrayList<String> resultList = JDBCTools.get("jdbcUrl",this.seach_sql,this.connection,receiverIdList.get(0),receiverType,year);
